 ...
 * 
 */
public class PrestrSeshAbstTest {
	...
	protected static final ChnlRscJustName rscA = new ChnlRscJustName("a");
	protected static final ChnlRscJustName rscB = new ChnlRscJustName("b");
	protected static final String audNameA = "testAudienceA";
	protected static final String audNameB = "testAudienceB";
	protected static final String audNameC = "testAudienceC";
